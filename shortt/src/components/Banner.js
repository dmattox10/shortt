        ...
        <Row>
            <Col xs='12'>
                <Jumbotron>
                    ...
                    <CardText>Enter a link to shorten, then suggest the text you'd like it shorten to. If it's not taken you'll get the link back, if it is taken the system will suggest a short random blurb, or you can try another blurb of your own.</CardText>
                </Jumbotron>
            </Col>
        </Row>
    )
